...
readonly columns: ColumnDef[] = [
  ...
  { colId: 'firstName', field: 'firstName', header: 'First Name', type: 'string', width: 140, rowDrag: true },
  { colId: 'lastName', field: 'lastName', header: 'Last Name', type: 'string', width: 140 },
  { colId: 'email', field: 'email', header: 'Email', type: 'string', width: 240 },
  ...
  { colId: 'country', field: 'country', header: 'Country', type: 'string', width: 150, groupable: true },
  ...
  { colId: 'bonus', field: 'bonus', header: 'Bonus', type: 'currency', width: 120 },
  { colId: 'projects', field: 'projects', header: 'Projects', type: 'number', width: 120 },
  { colId: 'performance', field: 'performance', header: 'Performance', type: 'string', width: 140 },
  { colId: 'manager', field: 'manager', header: 'Manager', type: 'string', width: 180 },
  { colId: 'remote', field: 'remote', header: 'Remote', type: 'boolean', width: 100 },
];
