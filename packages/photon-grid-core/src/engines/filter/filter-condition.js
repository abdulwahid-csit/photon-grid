...
export function evaluateStringCondition(condition, cellValue) {
...
export function evaluateNumberCondition(condition, cellValue) {
...
export function evaluateDateCondition(condition, cellValue) {
...
export function evaluateSetCondition(operator, selectedIds, cellValue) {
...
export function evaluateBooleanCondition(condition, cellValue) {
    switch (condition.operator) {
        case 'equals':
...
//# sourceMappingURL=filter-condition.js.map