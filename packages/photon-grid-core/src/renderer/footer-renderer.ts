...
export class FooterRenderer {
  ...
  updatePaginationState(): void {
    ...
    const pageInfo = this.footerEl.querySelector<HTMLElement>('.pg-pagination__info');
    if (pageInfo) {
    ...
    const firstBtn = this.footerEl.querySelector<HTMLButtonElement>('[data-action="first"]');
    const prevBtn = this.footerEl.querySelector<HTMLButtonElement>('[data-action="prev"]');
    const nextBtn = this.footerEl.querySelector<HTMLButtonElement>('[data-action="next"]');
    const lastBtn = this.footerEl.querySelector<HTMLButtonElement>('[data-action="last"]');
  ...
  private buildPaginationControls(): HTMLElement {
  ...
  private getConfig(): PaginationConfig {
    return {
      enabled: true,
