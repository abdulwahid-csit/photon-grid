...
document.getElementById("collapse-comp").addEventListener("click", () => grid.api.collapseColumnGroup("Compensation"));
document.getElementById("expand-comp").addEventListener("click", () => grid.api.expandColumnGroup("Compensation"));
document.getElementById("log-state").addEventListener("click", () => console.log(grid.api.getColumnGroupState()));
