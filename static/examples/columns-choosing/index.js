...
function toggleColumn(colId) {
  ...
  grid.api.setColumnVisible(colId, !visibleIds.includes(colId));
}

document.getElementById("toggle-country").addEventListener("click", () => toggleColumn("country"));
document.getElementById("toggle-salary").addEventListener("click", () => toggleColumn("salary"));
document.getElementById("hide-comp").addEventListener("click", () => grid.api.setColumnsVisible(["salary", "active"], false));
document.getElementById("show-comp").addEventListener("click", () => grid.api.setColumnsVisible(["salary", "active"], true));
