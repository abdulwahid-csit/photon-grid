const columns = [
  ...
  { field: "name",       header: "Employee",   colId: "name",       flex: 2,    minWidth: 160, sortable: true, filter: true, tooltip: "Full employee name" },
  { field: "department", header: "Department", colId: "department", flex: 1,    minWidth: 140, sortable: true, filter: true },
  { field: "country",    header: "Country",    colId: "country",    flex: 1,    minWidth: 120, sortable: true, filter: true },
  { field: "salary",     header: "Salary",     colId: "salary",     width: 120, sortable: true, filter: true, tooltip: "Annual gross salary in USD" },
