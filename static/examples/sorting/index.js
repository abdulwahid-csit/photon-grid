const columns = [
  { field: "id",         header: "ID",         colId: "id",         width: 80, configurable: false, sortable: true },
  ...
  { field: "country",    header: "Country",    colId: "country",    flex: 1, sortable: true },
...
api.on("sort:changed", function () {
  const config = api.getSortConfig();
  statusEl.textContent = "Sort: " + JSON.stringify(config);
});
