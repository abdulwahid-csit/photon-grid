// Sparklines ship in the CDN build under the PhotonGrid global — no extra
// script is required. Enable them with the `sparkline` grid option.
const columns = [
...
// `sparkline: {}` is an illustrative placeholder that references the confirmed
// option and confirms the feature is bundled — no separate install needed.
