// Sortable and filterable columns show the grid's built-in sort and filter icons.
const columns = [
...
// The theme colors the sort and filter icons; toggling dark mode recolors them.
